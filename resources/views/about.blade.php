        ...
        <section data-pcid="4040.2" id="kpg_509457" class="kedit" data-bgcolor="#EEEFF5" style="background:#EEEFF5">
            <div class="container">
                ...
                <div class="text-center col-lg-8 mx-auto">
                    ...
                    <div class="keditable koPreTitle aos-init aos-animate" data-aos="fade-in">{{__('about.title')}}
                    </div>
                    ...
                    <div class="koSeparator koSeparatorBlock aos-init aos-animate" data-aos="fade-in" data-bg="--color1"
                        style="background: var(--color1); width: 100px;">
                    </div>
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-4 p-2 kimgcover">
                                    ...
                                    <img class="kimgfilter3 lazy entered loaded"
                                         ...
                                         data-src="{{asset('data/images/about_2.webp') }}"
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-4 p-2 kimgcover">
                                    ...
                                    <img class="kimgfilter3 lazy entered loaded"
                                         ...
                                         data-src="{{asset('data/images/concrete.webp') }}"
                                         data-ll-status="loaded"
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-4 p-2 kimgcover">
                                    ...
                                    <img class="kimgfilter3 lazy entered loaded"
                                         ...
                                         data-src="{{asset('data/images/stucco.webp') }}"
                                         data-ll-status="loaded"
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-4 p-2 kimgcover">
                                    ...
                                    <img class="kimgfilter3 lazy entered loaded"
                                        ...
                                        data-src="{{ asset('data/images/stamp_concrete.webp') }}"
                                         data-ll-status="loaded"
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-4 p-2 kimgcover">
                                    ...
                                    <img class="kimgfilter3 lazy entered loaded"
                                         ...
                                         data-src="{{asset('data/images/about_3.webp')}}"
                                         data-ll-status="loaded"
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-4 p-2 kimgcover">
                                    ...
                                    <img class="kimgfilter3 lazy entered loaded"
                                         ...
                                         data-src="{{asset('data/images/pavers.webp') }}"
                                         data-ll-status="loaded"
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-4 p-2 kimgcover">
                                    ...
                                    <img class="kimgfilter3 lazy entered loaded"
                                        ...
                                        data-src="{{asset('data/images/about_4.webp')}}"
                                         data-ll-status="loaded"
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-4 p-2 kimgcover">
                                    ...
                                    <img class="kimgfilter3 lazy entered loaded"
                                         ...
                                         data-src="{{asset('data/images/fences.webp') }}"
                                         data-ll-status="loaded"
