                    ...
                    <div class="col-8">
                        ...
                        <form method="POST" action="{{route('contact.send')}}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="full_name" class="form-control" id="name" placeholder="{{__('contact.form_fields.full_name_placeholder')}}">
                            </div>
                            <div class="mb-3">
                                <label for="email" class="form-label">{{__('contact.form_fields.email')}}</label>
                                <input type="email" name="email" class="form-control" id="email" placeholder="{{__('contact.form_fields.email_placeholder')}}">
                            </div>
                            <div class="mb-3">
                                <label for="phone" class="form-label">{{__('contact.form_fields.subject')}}</label>
                                <input type="text" name="subject" class="form-control" id="subject" placeholder="{{__('contact.form_fields.subject_placeholder')}}">
                            </div>
                            <div class="mb-3">
                                ...
                                {!! NoCaptcha::display() !!}
                            <button type="submit" class="btn btn-primary">{{__('contact.form_fields.submit')}}</button>
                        </form>
                        {!! NoCaptcha::renderJs() !!}
                    </div>
                </div>
