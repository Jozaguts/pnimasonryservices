        ...
        <div class="container">
            <div class="logoHolder skiptranslate">
                <a href="{{ LaravelLocalization::localizeUrl('/') }}" class="logo">
                    <h2>
                        <img src="{{ asset('data/files/screenshot2024-10-10at4.01.51am.png') }}" style="border:0" id="WebsiteLogo" alt="PNI Masonry Services">
            ...
            <ul class="menuHolder topmenu">
                ...
                <li><a href="{{ LaravelLocalization::localizeUrl('about') }}"><span>{{ __('ui.nav.about') }}</span></a></li>
                <li><a href="{{ LaravelLocalization::localizeUrl('gallery') }}"><span>{{ __('ui.nav.gallery') }}</span></a></li>
                <li><a href="{{ LaravelLocalization::localizeUrl('services') }}"><span>{{ __('ui.nav.services') }}</span></a></li>
